classdef Violin < handle
    ...
    methods
        function obj = Violin(data, pos, varargin)
            ...
            if numel(data) == 1
                obj.MedianPlot = scatter(pos, data, 15, 'filled');
...
%             obj.MeanPlot.LineWidth = 1;
            ...
            if ~isempty(lowhisker) && ~isempty(hiwhisker)
                ...
                obj.WhiskerPlot.LineWidth = 1.5;
            end
            
                     
            obj.MedianPlot = scatter(pos, quartiles(2), 15, [1 1 1], 'filled');
            ...
            jitter = 2*(rand(size(data))-0.5);
            obj.ScatterPlot = ...
                scatter(pos + jitter.*jitterstrength, data, 5, 'filled', 'LineWidth', 0.5, 'MarkerEdgeColor', 'k');
